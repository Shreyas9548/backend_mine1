...
urlpatterns = [
    ...
    path('documents/', docview.DocumentListAPIView.as_view(), name='vendors-list'),#documents
    ...
    path('create-dynamic-model/', dyv.CreateDynamicModelView.as_view(), name='create_dynamic_model'),#dynamic_models
    ...
    path('deduplicate/', simviews.deduplicate_view, name='deduplicate'),#deduplicate
    path('create-custom-field/', cfviews.create_custom_field, name='create_custom_field'),#customfield
    path('retrieve-all-custom-fields/', cfviews.retrieve_all_custom_fields, name='retrieve_all_custom_fields'),
    path('retrieve-custom-fields/<str:model_name>/<int:entity_id>/', cfviews.retrieve_custom_fields, name='retrieve_custom_fields'),
    ...
    path('tickets/', tickview.TicketListAPIView.as_view(), name='ticket-list'),#tickets
